...
At the end of this project, you are expected to be able to [explain to anyone](https://intranet.alxswe.com/rltoken/XLLmLISlteUIxrLzNdm3_Q), **without the help of Google**:
